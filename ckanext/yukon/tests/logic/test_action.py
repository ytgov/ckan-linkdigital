"""Tests for ckanext.yukon.logic.action."""
...
from ckanext.yukon.model import Something


@pytest.mark.ckan_config("ckan.plugins", "yukon")
@pytest.mark.usefixtures("with_plugins")
def test_get_sum():
    """Sum is correct."""
    result = call_action("yukon_get_sum", left=10, right=30)
